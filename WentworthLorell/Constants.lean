...
lemma log_four : Real.log (4 : ℝ) = 2 * Real.log 2 := by
  rw [show (4 : ℝ) = 2 * 2 by norm_num, Real.log_mul (by norm_num) (by norm_num)]
  ring

lemma log_quarter : Real.log (1 / 4 : ℝ) = -2 * Real.log 2 := by
  rw [Real.log_div (by norm_num) (by norm_num), Real.log_one, log_four]
  ring

lemma log_three_quarters : Real.log (3 / 4 : ℝ) = Real.log 3 - 2 * Real.log 2 := by
  rw [Real.log_div (by norm_num) (by norm_num), log_four]
...
theorem explicit_kl_margin :
  ...
  have hsecond' :
    ...
    all_goals
      field_simp [ne_of_gt hp, ne_of_gt (sub_pos.mpr hp1)]
      ring
